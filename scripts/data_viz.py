...
def app():
    ...
    #Reading the data
    training_sample_subset=pd.read_csv("/home/mahlet/10ac/Sales_prediction/RF_train.csv")
    ...
    ax = sns.countplot(x='Sales', hue='StoreType', data=training_sample_subset, palette='Set1')
